...
public enum LabelStringKey implements Name {
    ...
    MainFrame_8(new DefaultName("MainFrame.8")),
    MainFrame_9(new DefaultName("MainFrame.9")),
    MainFrame_10(new DefaultName("MainFrame.10")),
    ...
    CoreConfig_18(new DefaultName("CoreConfig.18")),
    CoreConfig_19(new DefaultName("CoreConfig.19")),
    CoreConfig_20(new DefaultName("CoreConfig.20")),
    CoreConfig_21(new DefaultName("CoreConfig.21")),
    ...
    JxlCountResultsSaver_4(new DefaultName("JxlCountResultsSaver.4")),
    JxlCountResultsSaver_5(new DefaultName("JxlCountResultsSaver.5")),
    JxlCountResultsSaver_6(new DefaultName("JxlCountResultsSaver.6")),
    JxlCountResultsSaver_7(new DefaultName("JxlCountResultsSaver.7")),
    JxlCountResultsSaver_8(new DefaultName("JxlCountResultsSaver.8")),
    JxlCountResultsSaver_9(new DefaultName("JxlCountResultsSaver.9")),
    JxlCountResultsSaver_10(new DefaultName("JxlCountResultsSaver.10")),
    JxlCountResultsSaver_11(new DefaultName("JxlCountResultsSaver.11")),
    JxlCountResultsSaver_12(new DefaultName("JxlCountResultsSaver.12")),
    JxlCountResultsSaver_13(new DefaultName("JxlCountResultsSaver.13")),
    JxlCountResultsSaver_14(new DefaultName("JxlCountResultsSaver.14")),
    JxlCountResultsSaver_15(new DefaultName("JxlCountResultsSaver.15")),
    JxlCountResultsSaver_16(new DefaultName("JxlCountResultsSaver.16")),
    JxlCountResultsSaver_17(new DefaultName("JxlCountResultsSaver.17")),
    JxlCountResultsSaver_18(new DefaultName("JxlCountResultsSaver.18")),
    JxlCountResultsSaver_19(new DefaultName("JxlCountResultsSaver.19")),
    JxlCountResultsSaver_20(new DefaultName("JxlCountResultsSaver.20")),
    JxlCountResultsSaver_21(new DefaultName("JxlCountResultsSaver.21")),
    JxlCountResultsSaver_22(new DefaultName("JxlCountResultsSaver.22")),
    JxlCountResultsSaver_23(new DefaultName("JxlCountResultsSaver.23")),
    JxlCountResultsSaver_24(new DefaultName("JxlCountResultsSaver.24")),
