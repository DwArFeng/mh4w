...
public final class Constants {
    ...
    static {
        ...
        defaultLoggerInfos = new HashSet<>(Collections.singletonList(new InnerLoggerInfo("std.all")));
        ...
        coreConfigOrder.add(CoreConfig.COUNT_COEFFICIENT_EXTRA_PHASE1);
        coreConfigOrder.add(CoreConfig.COUNT_COEFFICIENT_WEEKEND);
        coreConfigOrder.add(CoreConfig.COUNT_COEFFICIENT_HOLIDAY);
        coreConfigOrder.add(CoreConfig.COUNT_COEFFICIENT_EXTRA_PHASE2);
        coreConfigOrder.add(CoreConfig.COUNT_COEFFICIENT_EXTRA_PHASE3);
        coreConfigOrder.add(CoreConfig.COUNT_COEFFICIENT_EXTRA_PHASE4);
     ...
     * @return 默认的记录器名称集合。
     */
    public static Set<LoggerInfo> getDefaultLoggerInfos() {
        return defaultLoggerInfos;
    }

    public static MutilangInfo getDefaultMutilangInfo() {
     ...
     * @return 文本缺失字段。
     */
    public static String getDefaultMissingString() {
     ...
     * @return 默认的记录器多语言信息。
     */
    public static MutilangInfo getDefaultLoggerMutilangInfo() {
     ...
     * @return 默认的标签多语言信息。
     */
    public static MutilangInfo getDefaultLabelMutilangInfo() {
